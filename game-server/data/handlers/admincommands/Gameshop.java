...
public class Gameshop extends AdminCommand {
  ...
  public Gameshop() {
    ...
    setSyntaxInfo(
      " - 未检测到参数，请使用以下命令：",
      "add <物品ID> <数量> <价格> <分类> <子分类> <物品类型> <礼物> <列表> <标题描述|empty> <物品描述|null> - 添加物品到商城",
      "delete <物品ID> <分类> <子分类> <列表> - 从商城移除物品",
      "addranking <物品ID> <数量> <价格> <物品类型> <礼物> <标题描述|empty> <物品描述|null> - 添加物品到排行榜销售",
      "deleteranking <物品ID> - 从排行榜销售移除物品",
      "settoll <目标|玩家名> <点券数> - 设置玩家点券数量",
      "addtoll <目标|玩家名> <点券数> - 向玩家添加点券"
    );
  }
