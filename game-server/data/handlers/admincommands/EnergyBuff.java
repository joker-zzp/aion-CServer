...
public class EnergyBuff extends AdminCommand {
  ...
  public void execute(Player player, String... params) {
    ...
    if (target == null) {
      PacketSendUtility.sendMessage(player, "未选择目标");
      return;
    }
    ...
    if (params == null || params.length < 1) {
      ...
      if (params[0].equals("repose")) {
        ...
        if (params[1].equals("info"))
          PacketSendUtility.sendMessage(player, "当前EoR: " + targetPlayer.getCommonData().getCurrentReposeEnergy() + "\n 最大EoR: "
        ...
        Player targetPlayer = (Player) creature;
        if (params[1].equals("info"))
          PacketSendUtility.sendMessage(player, "当前EoS: " + targetPlayer.getCommonData().getCurrentSalvationPercent());
        else if (params[1].equals("add"))
